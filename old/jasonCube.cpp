...
int main() {
    ...
    void main()
    {
        ...
        outUvs = inUvs;
        outColor = inColor;
        gl_Position = projection * matrix * rotationY * rotationX * vec4(inPosition,1);
    }
    )END";
    ...
    glm::mat4 projectionMatrix = glm::perspective(glm::radians(60.0f), 1.0f, 0.f, 10.0f) * scaleMatrix;
